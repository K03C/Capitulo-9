...
/*Observa que la función fread tiene los mismos argumentos que la funcion fwrite del programa anterior. Tambien es importante tomar nota de que cuando
...
instrucción del mismo. Esto se debe a que la logica que siguen las

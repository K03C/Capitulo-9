...
t = sizeof(empleado);
/*La función sizeof se utiliza para concocer el tamaño de la estructura
empleado. */
...
{
    i = ftell(ap) / t;
    /*La función ftell se utiliza para concoer la posición de nuestro
    apuntador en el archivo. La variable i nos proporciona en este caso
    el tamaño de todos los bloques que existen debajo de nuestra posición. Si conocemos el tamaño de cada bloque, entonces podmeos

...
/*Archivos con variables enteres y reales.
...
void promedio(FILE *);
/*Prototipo de funcion. Se pasa un archivo como parámetro. */
...
{
    promedio(ar);       /*Se llama a la funcion promedio. Observe la fomra como se pasa el archivo como parametro. */
